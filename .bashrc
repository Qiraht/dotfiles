...
# Powerline-Go
export PLGO_HOSTNAMEFG=Green
GOPATH="/home/qiraht/Extras/"
function _update_ps1() {
    PS1="$($GOPATH/powerline-go-linux-amd64 -error $? -cwd-max-depth 2 -mode patched -colorize-hostname -jobs $(jobs -p | wc -l))"
}
if [ "$TERM" != "linux" ] && [ -f "$GOPATH/powerline-go-linux-amd64" ]; then
...
# Utilities
alias cls='clear'
alias prun='prime-run'
alias gaming='prime-run gamemoderun'

# Wine
alias wine64='WINEARCH=win64'
